...
class TestSeries(unittest.TestCase):
    ...
    def testBasicAttributes(self):
        ...
        self.assertEqual(self.series.url,
                         'https://patchwork.kernel.org/api/series/565705/')
        self.assertEqual(self.series.web_url,
        ...
        self.assertEqual(self.series.mbox,
                         'https://patchwork.kernel.org/series/565705/mbox/')
        self.assertIsInstance(self.series.get_project(),
                              patchwork.Project.Project)
        self.assertIsInstance(self.series.get_submitter(),
                              patchwork.People.People)
        self.assertIsInstance(self.series.get_cover_letter(),
    ...
    def testCoverLetter(self):
        ...
        self.assertEqual(cover.url,
                         "https://patchwork.kernel.org/api/covers/12567485/")
        self.assertEqual(cover.web_url,
                         "https://patchwork.kernel.org/project/bluetooth/cover/20211018172833.534191-1-hj.tedd.an@gmail.com/")
        self.assertEqual(cover.msgid,
                         "<20211018172833.534191-1-hj.tedd.an@gmail.com>")
        self.assertEqual(cover.list_archive_url,
