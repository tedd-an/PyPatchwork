...
class TestComment(unittest.TestCase):
    ...
    def testBasicAttributes(self):
        ...
        self.assertEqual(self.comment.web_url,
                         "https://patchwork.kernel.org/comment/24531077/")
        self.assertEqual(self.comment.msgid,
                         "<616db65f.1c69fb81.c4a83.fe17@mx.google.com>")
        self.assertEqual(self.comment.list_archive_url,
    ...
    def testSubmitter(self):
        ...
        self.assertEqual(submitter.url,
                         "https://patchwork.kernel.org/api/people/191843/")
